...
import { axiosistance } from '../../Network/axiosistance';export default function AddUser() {
  ...
  <div className="container">
        <form onSubmit={registerSubmit} className='py-5'>
            <h1 className='mb-3 fs-1 py-3 border-bottom'> Add user </h1>
       ...
       <button className='btn btn-danger rounded  py-2 px-5'>{isLoading === true ? (<i className='fa-solid fa-spinner fa-spin'></i>) : ("Add User")}</button>
